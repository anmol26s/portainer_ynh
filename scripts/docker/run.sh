...
[ "$architecture" == "amd64" ] && image=portainer/portainer-ce:2.0.0
[ "$architecture" == "i386" ]  && image=portainer/portainer-ce:linux-386-2.0.0
[ "$architecture" == "armhf" ] && image=portainer/portainer-ce:linux-arm-2.0.0
